...
import { SALON, MAPS_EMBED_URL, MAPS_DIR_URL, waBookingMessage } from "./config";
...
function SectionCTA({ tone = "light", kicker }: { tone?: "light" | "dark"; kicker: string }) {
  const dark = tone === "dark";
  const goToBooking = () => document.getElementById("booking-calendar")?.scrollIntoView({ behavior: "smooth" });
  return (
    <Reveal className={`mt-16 lg:mt-24 pt-8 flex flex-col md:flex-row md:items-center justify-between gap-6 ${dark ? "border-t border-[#faf8f3]/12" : "border-t border-[#111]/10"}`}>
      <p className={`font-display text-2xl lg:text-3xl ${dark ? "text-[#faf8f3]" : "text-[#111]"}`}>{kicker}</p>
      <div className="flex flex-wrap items-center gap-3">
        <button onClick={goToBooking} className="btn btn-primary">Reservar cita <span className="arr">→</span></button>
        <WhatsAppButton variant="inline" tone={tone} size="sm" label="WhatsApp" />
        <a href={`tel:${SALON.phoneRaw}`} className={`btn btn-ghost ${dark ? "text-[#faf8f3]" : "text-[#111]"}`}>Llamar</a>
      </div>
    </Reveal>
  );
}
  ...
  return (
    <section id="servicios" className="bg-white">
      <div className="max-w-[1300px] mx-auto px-5 lg:px-10 py-24 lg:py-32">
            ...
            <Reveal key={svc.num} delay={i * 60}>
              <div className="group grid grid-cols-12 gap-4 py-7 lg:py-8 border-b border-[#111]/10 items-center">
                ...
                <div className="col-span-7 lg:col-span-3 flex items-center justify-end gap-4">
                  ...
                  <a href="#booking-calendar" className="hidden lg:inline-flex nav-link font-mono text-[10px] tracking-[0.18em] text-[#7a1f2b] pb-1 opacity-0 group-hover:opacity-100 transition-opacity">RESERVAR</a>
                </div>
                <div className="col-span-12 lg:hidden flex gap-2 -mt-1">
                  <a href="#booking-calendar" className="btn btn-primary btn-sm">Reservar</a>
                  <WhatsAppButton variant="inline" tone="light" size="sm" label="WA" message={waBookingMessage(svc.title)} />
                </div>
              </div>
            </Reveal>
          ))}
        ...
        <SectionCTA kicker="¿Empezamos por la carta?" />
      </div>
    </section>
  );
}
  ...
  return (
    <section id="testimonios" className="bg-[#faf8f3]">
      <div className="max-w-[1300px] mx-auto px-5 lg:px-10 py-24 lg:py-32">
        ...
        <SectionCTA kicker="¿Te convencen?" />
      </div>
    </section>
  );
}
  ...
  return (
    <section id="ubicacion" className="bg-[#faf8f3]">
      <div className="max-w-[1300px] mx-auto px-5 lg:px-10 py-24 lg:py-32">
            ...
            <div className="bg-white border border-[#111]/10 p-6 lg:p-8 h-full flex flex-col">
              ...
              <div className="mt-auto flex flex-col gap-3">
                ...
                <div className="flex gap-3">
                  ...
                  <WhatsAppButton variant="inline" tone="light" size="md" label="WhatsApp" className="flex-1" />
                </div>
              </div>
            </div>
          </Reveal>
        ...
        <SectionCTA kicker="Pásate cuando quieras." />
      </div>
    </section>
  );
}
          ...
          <div className="lg:col-span-5 lg:border-l lg:border-[#faf8f3]/12 lg:pl-10">
            <Reveal delay={120} className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                <WhatsAppButton variant="inline" tone="dark" label="WhatsApp" />
                <a href={MAPS_DIR_URL} target="_blank" rel="noopener noreferrer" className="btn btn-ghost text-[#faf8f3]">Cómo llegar</a>
                <a href={`tel:${SALON.phoneRaw}`} className="btn btn-ghost text-[#faf8f3]">Llamar</a>
              </div>
